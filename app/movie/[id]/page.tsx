   ...
   <div className='rounded-lg border p-3  bg-white mb-6'>
    ...
    <div>
      <form action={postData}>
        <textarea id="text" minLength={5} className='w-full border text-black border-teal-400 rounded-md p-3 mb-3' name="comment" placeholder="add your comment..."></textarea>
